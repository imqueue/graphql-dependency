/*!
 * @imqueue/graphql-dependency: signature
 *
 ...
 * @param ancestors - stack of objects on the current descent path, used for
 *                    cycle detection
 * @returns the serialized value, or `undefined` where JSON would omit it
